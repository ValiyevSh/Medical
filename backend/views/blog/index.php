...
<div class="slider-index">
    ...
    <section class="content">
        <a href="<?= url::to(['blog/create']) ?>"> <span style="margin-left: 95%; color:white;" class="btn btn-info">
                                    ...
                                    'columns' => [
                                        ...
                                        [
                                            ...
                                            'value' => function ($model, $url) {
                                                ...
                                                return "<a href='" . url::to(['blog/status', 'id' => $model->id]) . "'> <span class='" . $class . "'>" . $text . "</span></a>";
                                            }
                                        ],
                                        [
